...
| **Dozzle** | Dozzle is a real-time log viewer for docker containers. | `amir20/dozzle` | v10.7.2 | 8888 | [▶️](https://youtu.be/lLLNDcHNOuM) |  |
...
| **Ghostfolio** | Open Source Wealth Management Software. Angular + NestJS + Prisma + Nx + TypeScript 🤍 | `ghostfolio/ghostfolio` | 3.53.0 | 3333 | [▶️](https://youtu.be/CNe4-8Vyhos) |  |
...
| **Matterbridge** | Matterbridge is a Matter plugin manager that allows you to have all your Matter devices up and ru... | `luligu/matterbridge` | 3.10.5 | 8283 |  |  |
...
| **n8n** | Free and open fair-code licensed node based Workflow Automation Tool. | `n8nio/n8n` | 2.35.3 | 5678 |  |  |
...
| **Ollama - AMD** | Get up and running with Llama 3, Mistral, Gemma, and other large language models. | `ollama/ollama` | 0.32.14-rocm | 11434 |  |  |
| **Ollama - CPU** | Get up and running with Llama 3, Mistral, Gemma, and other large language models. | `ollama/ollama` | 0.32.14 | 11434 |  |  |
| **Ollama - NVIDIA** | Get up and running with Llama 3, Mistral, Gemma, and other large language models. | `ollama/ollama` | 0.32.14 | 11434 |  |  |
| **OneDev** | Self-hosted Git Server with Kanban and CI/CD | `1dev/server` | 16.5.4 | 6610 | [▶️](https://youtu.be/ps3JLYRB3SA) |  |
...
| **Password Pusher v2** | Password Pusher is an open source application to communicate passwords over the web. Links to pas... | `pglombardo/pwpush` | 2.11.0 | 5101 | [▶️](https://youtu.be/U17LWqXfOmU) | [📖](https://docs.pwpush.com/docs/upgrading/) |
...
| **Reactive Resume** | A free and open-source resume builder that simplifies the process of creating, updating, and shar... | `amruthpillai/reactive-resume` | v5.2.6 | 3000 |  |  |
...
| **Tianji** | During our observations of the website. We often need to use multiple applications together. For ... | `moonrailgun/tianji` | 1.32.24 | 12345 |  |  |
...
| **WordPress v7** | Initially started as a blogging tool in 2003, it has evolved into a highly flexible CMS that powe... | `wordpress` | 7.0.4 | 8084 | [▶️](https://youtu.be/j5M4qlRCbYs) |  |
