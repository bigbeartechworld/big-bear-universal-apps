...
| **Budibase** | Low code platform for creating internal tools, workflows, and admin panels in minutes. Supports P... | `budibase/budibase` | v3.44.0 | 8080 |  |  |
...
| **Dozzle** | Dozzle is a real-time log viewer for docker containers. | `amir20/dozzle` | v10.9.2 | 8888 | [▶️](https://youtu.be/lLLNDcHNOuM) |  |
...
| **Ghostfolio** | Open Source Wealth Management Software. Angular + NestJS + Prisma + Nx + TypeScript 🤍 | `ghostfolio/ghostfolio` | 3.67.1 | 3333 | [▶️](https://youtu.be/CNe4-8Vyhos) |  |
...
| **OneDev** | Self-hosted Git Server with Kanban and CI/CD | `1dev/server` | 16.5.11 | 6610 | [▶️](https://youtu.be/ps3JLYRB3SA) |  |
...
| **Wallos** | Wallos: Open-Source Personal Subscription Tracker | `bellamy/wallos` | 5.5.0 | 8282 | [▶️](https://youtu.be/feYTW02YDb8) |  |
